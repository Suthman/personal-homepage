...
header:
  overlay_image: /assets/images/2026-review-clean-architecture/clean_architecture_title.jpg
...
- 3.1, 3.2 abd 3.3: copy the summary!!!
...
- operations: Delaware decision as long as possible. If component structure is good, we can later decide on concrete deployent and Operation modi
...
- todo mentiln referebces from p211
-- common:
...
- Clean arcotecture picture: p212 (better with color?!)
- Dependency Rule
...
--> changes herevwill not affect entities,  changes in GUI or DB will have not impact here
- interface adapters
...
-- Leave away the packaging, i.e. less effort for release and deployment Management
Todo was heißt reziprok?
...
-> treat UI as a detail and protect highe components from changes
...
-> "get the milk without buyin the cow" todo geht das in englisch?
...
- devil ließ in Implementation details
-- public is used too often in languages like
Java
...
- intetedtinh collectoln of Uncle Bob's Projekts and experience
...
- ch 24 partial boundaries: can risks be reduced by arcuniz? Same holds for ch 34
-> forgot the name

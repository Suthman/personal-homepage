...
--- esp decision making with multiple vague and conflicting constraknts can be handld by unconscious mind -> 
Unconscious thought theory (utt)
--- let Conscious mind rest to enable unconcious mind
--- üersonal: solve Problems over night
...
-- you can expect effort invested by the Sender, if he expect that you spend effort
In an answer
...
Take away:
- dw not only efficieny aspect but also valuable and "fulfilling"
- tryouts
--Fixed schedule
-- Planung and Abschluss 
-- depth Monitoring 
-- Mail strategies
-- sicial media (teams and Outlook)
